...
#if 1
	// 设置背景
	g_book_ui.background = lv_image_create(book_view.screen);
	lv_image_set_src(g_book_ui.background, "A:./resources/image/background.png");
	lv_obj_align(g_book_ui.background, LV_ALIGN_CENTER, 0, 0);
	lv_obj_move_background(g_book_ui.background);
#endif
