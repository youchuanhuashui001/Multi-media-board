...
#
CPPFLAGS := 
CFLAGS   := -c -Wall -g -O2 -fvisibility=hidden   -I/usr/include/libpng16 -I/usr/local/include -pthread \
...
# Linker flags.
#
LDFLAGS :=  -lz -lbz2 -lpng16 -lz -L/usr/local/lib -lbrotlidec -pthread -lpthread
