...
#
prefix       := /home/tanxzh/project/100ask/Multi-media-board/Code/module/lcd/lib/freetype-2.13.3/tmp
exec_prefix  := ${prefix}
...
LIBSSTATIC_CONFIG          := -lfreetype -lz -lbz2 -lpng16 -lm -lz -lm -lz -L/usr/local/lib -lbrotlidec -lbrotlicommon
build_libtool_libs         := 
ft_version                 := 26.2.20
