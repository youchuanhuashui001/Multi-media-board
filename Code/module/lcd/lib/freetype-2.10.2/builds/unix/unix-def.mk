...
#
prefix       := /home/tanxzh/project/100ask/Multi-media-board/Code/module/lcd/lib/freetype-2.10.2/tmp
exec_prefix  := ${prefix}
...
REQUIRES_PRIVATE   := zlib, libpng, harfbuzz >= 1.8.0, libbrotlidec
LIBS_PRIVATE       := -lbz2
LIBSSTATIC_CONFIG  := -lfreetype -lz -lbz2 -lpng16 -lm -lz -lm -lz -L/usr/local/lib -lharfbuzz -lm -lglib-2.0 -pthread -lm -lpcre -lfreetype -lpng16 -lm -lz -lm -lz -lbrotlidec -lbrotlicommon -lgraphite2 -L/usr/local/lib -lbrotlidec -lbrotlicommon
build_libtool_libs := 
ft_version         := 23.2.17
